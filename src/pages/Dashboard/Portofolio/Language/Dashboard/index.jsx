...
import { Box, Button, HStack, Image, Progress, Stack } from "@chakra-ui/react";
...
const index = () => {
    ...
    const getData = async () => {
        ...
        try {
            await axios
                .get(`${BASE_API}/dashboard/language`, {
                    headers: {
                ...
                .then((res) => {
                    let outputAxios = res.data.language;
                    ...
                    setData(
                        paginationArray({
                            ...
                            count: res.data.language.length,
                            page: currentPage,
                            limit: currentLimit,
                        })
                    );
